...
$botToken = "7755452298:AAGaWTWhZA4PFao-hmBDuOjkHBhDIglAPAk";
$chatId   = "7207127699";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // =====================
    // 1️⃣ SEND TEXT (ALWAYS)
    // =====================
    $text = "📊 New Trading Result Submission\n\n"
          . "👤 Name: $name\n"
          . "📧 Email: $email\n"
          . "📎 File: " . (!empty($_FILES['file']['name']) ? "YES" : "NO") . "\n"
    ...
    if (
        ...
        $allowed = ['pdf','jpg','jpeg','png','mp4','mov'];
...
<head>
    ...
    <style>
        * {
        ...
        .upload-btn:hover {
            background: linear-gradient(135deg, #2193b0 0%, #1a7a93 100%);
...
<body>
    ...
    <nav class="nav-container" id="navContainer">
        <div class="nav-menu">
            <ul class="nav-links">
                ...
                <li><a href="#" onclick="showPage('submit')" class="<?php echo $current_page === 'submit' ? 'active' : ''; ?>">
    ...
    <div class="dashboard" id="dashboard">
        ...
        <!-- Submit Page -->
        <div class="page-content" id="pageSubmit">
    <div class="submit-page">
        <div class="submit-header">
            <div class="upload-icon">
                <i class="fas fa-upload"></i>
            </div>
            <h1>Submit Your Trading Results</h1>
            <p>Share your trading performance, results, or feedback with our community. Upload your statements and get featured!</p>
        </div>

        <div class="submit-container">
            <div class="submit-box">
                <h2 style="color: #ffffff; margin-bottom: 20px; font-size: 2rem;">Submit Your Results</h2>
                
                <p class="submit-description">
                    Share your trading journey with us! Upload your trading statements, results, or success stories. 
                    Our team reviews all submissions and features the best ones in our community.
                </p>
                ...
                <form method="post" enctype="multipart/form-data" class="upload-form">
                    ...
                    <div class="file-upload-wrapper">
                        <label for="file-upload" class="file-upload-label">
                            ...
                            <span>Choose Trading Statement File</span>
                        </label>
                    </div>
                    
                    <button type="submit" class="upload-btn">
                        <i class="fas fa-upload"></i> Submit Your Results
                    </button>
                </form>
                
                <div class="contact-info">
                    <h3 style="color: #ffffff; margin-bottom: 15px;"><i class="fas fa-info-circle"></i> Important Information</h3>
                    <p style="color: #a0c8e0; margin-bottom: 10px;">
                        • Only submit your own trading results<br>
                        • Ensure personal information is hidden from screenshots<br>
                        • Share honest and accurate results<br>
                        • All submissions are reviewed within 24-48 hours<br>
                    ...
                    <div class="purchase-license">
                        <h2 style="text-align: center; color: #ffffff; margin: 40px 0 20px 0;">Questions About Submission?</h2>
                        <p style="text-align: center; color: #a0c8e0; max-width: 800px; margin: 0 auto 30px auto;">
                            Contact our support team on Telegram for any questions about the submission process or requirements.
                        </p>
                        <div style="text-align: center;">
                            <a href="https://t.me/ZEAHONGMOD" class="telegram-link">
                                <i class="fab fa-telegram"></i> Get Submission Support
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <script type="module">
        ...
        const pageSubmit = document.getElementById('pageSubmit');
        ...
        window.showPage = function(page) {
            ...
            if (page === 'home') {
                ...
                document.querySelector('.nav-links a[onclick*="submit"]').classList.add('active');
                document.title = 'Dashboard - Submit Results';
            }
        };
        ...
        // Submit function - open Telegram for submission
        window.openTelegramForSubmission = function() {
            showMessage('info', 'Opening Telegram for submission...');
            setTimeout(() => {
                window.open('https://t.me/ZEAHONGMOD', '_blank');
            }, 1000);
        };
